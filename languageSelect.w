...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div class="x-contents-content" xid="content3"><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel29">
  ...
  <div component="$UI/system/components/bootstrap/row/row" class="row lang-btn" xid="row2">
   <div class="col col-xs-6" xid="col4"><a component="$UI/system/components/justep/button/button" class="btn btn-style" label="应用" xid="button73" onClick="button73Click">
      <i xid="i74"></i>
      <span xid="span148">应用</span></a></div>
   <div class="col col-xs-6" xid="col5"><a component="$UI/system/components/justep/button/button" class="btn btn-warning" label="返回" xid="button74" target="content2">
      <i xid="i73"></i>
      <span xid="span147">返回</span></a></div>
   </div></div> 
   </div></div><div class="x-contents-content" xid="content2"><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel2">
   <div class="x-panel-top" xid="top2"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="欢迎">
   ...
   <div class="x-panel-content lang-wrap" xid="content4"><div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form" xid="form1"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelSelect1">
  ...
  <div component="$UI/system/components/bootstrap/row/row" class="row lang-btn" xid="row1">
   <div class="col col-xs-6" xid="col1"><a component="$UI/system/components/justep/button/button" class="btn btn-style" label="确认" xid="button1" bind-click="button1Click">
   <i xid="i1"></i>
   <span xid="span1">确认</span></a></div>
   <div class="col col-xs-6" xid="col2"><a component="$UI/system/components/justep/button/button" class="btn btn-warning" label="设置" xid="button2" target="content3">
   <i xid="i2"></i>
