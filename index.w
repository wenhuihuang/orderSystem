...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <column label="用户名或密码有误" name="USERORPWD" type="String" xid="xid129"></column></div>
 ...
 <li xid="li2" bind-click="li2Click"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output5" bind-ref="ref('typeName')"></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel11">
   ...
   <div class="x-panel-bottom menu-bottom-wrap" xid="bottom3">
    <div xid="div53" class="menu-bottom-right">
     <a component="$UI/system/components/justep/button/button" class="btn back-btn" label="返回菜单" xid="button12" target="menu">
      <i xid="i6"></i>
      <span xid="span136">返回菜单</span></a> </div> </div> </div></div>
  </div>
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver renShu" xid="popOver_renshu" opacity="1">
   <div class="x-popOver-overlay" xid="div1"></div>
   <div class="x-popOver-content con-wrap" xid="div6"><div xid="div7" class="con-con"><h2 xid="h22" bind-text="language.val('INPUTNUM')"><![CDATA[请输入就餐人数]]></h2><input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" id="custNum" dataType="Integer" autoFocus="true" placeHolder="输入人数"></input><div xid="div8" class="btn-wrap"><a component="$UI/system/components/justep/button/button" class="btn btn-default undo-btn" label="取消" xid="button17" onClick="button17Click">
   <i xid="i19"></i>
   <span xid="span6" bind-text="language.val('CANCEL')">取消</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-default do-btn" label="确认" xid="button16" onClick="button16Click">
   <i xid="i18"></i>
   <span xid="span5" bind-text="language.val('CONFIRM')">确认</span></a>
  </div></div>
  </div></div>
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver take" xid="popOver-take" opacity="1">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default undo-btn" label="取消" xid="button26" bind-click="button26Click">
      <i xid="i27"></i>
      <span xid="span14" bind-text="language.ref('CANCEL')">取消</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-default do-btn" label="确认" xid="button25" onClick="button25Click">
      <i xid="i28"></i>
      <span xid="span15" bind-text="language.ref('CONFIRM')">确认</span></a></div> </div></div></div>
        ...
        <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
          ...
          <div class="x-panel-top" xid="top7" height="48"> 
            <div component="$UI/system/components/justep/button/buttonGroup"
              class="btn-group btn-group-justified order-info-title-btn" tabbed="true" xid="buttonGroup2">
   ...
   <div class="x-panel-content" xid="content52"><div xid="div16" class="pop-con"> 
  ...
  <div class="col col-xs-4" xid="col17">
   <span xid="span131" bind-click="button6Click" bind-text="language.ref('BACK')" class="back">返回</span></div></div></div> 
                </div><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full con-con" xid="panel28">
   <div class="x-panel-top" xid="top11" height="56"><p class="no-send order-info-title" xid="p10">
   ...
   <span xid="span84" bind-text="language.val('TOTALPRICESYUN')+':'" class="ml20"></span>
  ...
  <div xid="div14" class="pop-con-title">
    ...
    <li xid="li8" bind-click="li8Click">
     <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row6">
      ...
      <div class="col col-xs-1dot7" xid="col21">
       <span xid="span64" bind-text="val('qty')" class="color-price">数量</span></div> 
      ...
      <div class="col col-xs-1dot7" xid="col23">
       <span xid="span66" bind-text="val('sprice') * val('qty')+val('addMoney')" class="color-price">总价</span></div> </div> </li> </ul> </div>
  </div>
   ...
   <div class="x-panel-bottom" xid="bottom22"><div xid="div20" class="bottom-wrap"> 
  ...
  <div class="col col-xs-4" xid="col14">
   <span xid="span16" bind-click="hiedClick" class="back">返回</span></div></div></div> 
                  
                </div>
              <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full con-con" xid="panel30">
   <div class="x-panel-top" xid="top23" height="56"><p class="no-send order-info-title" xid="p1">
   <span xid="span75" bind-text="language.val('TOTALQ')+':'">总数量：</span>
   <span xid="span22" bind-text="$model.orderData.sum('qty')" class="color-price"></span>
   <span xid="span22" bind-text="language.val('TOTALPRICESYUN')+':'" class="ml20"></span>
   <span xid="span25" bind-text='$model.statusData.val("orderTotal")' class="color-price"></span></p>
  <div xid="div15" class="pop-con-title">
    ...
    <li xid="horderli" bind-click="horderliClick">
     <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row7">
      ...
      <div class="col col-xs-1dot7" xid="col27">
       <span xid="span45" bind-text="val('qty')" class="color-price">数量</span></div> 
      ...
      <div class="col col-xs-1dot7" xid="col28">
       <span xid="span43" bind-text="val('totalPrice')" class="color-price">总价</span></div> </div> </li> </ul> </div></div>
   ...
   <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup5">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link" xid="button46" label="预览结帐单" bind-click="span92Click">
     <i xid="i50"></i>
     <span xid="span57" class="color-style">预览结帐单</span></a> 
  ...
  <div class="col col-xs-4" xid="col16">
   <span xid="span17" bind-click="hiedClick" class="back">返回</span></div></div></div></div></div>
  </div>
            </div>
          </div>  
          </div> 
    ...
    <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" xid="popOver2" opacity="1" style="box-shadow:0 0px 2px 2px #B9B9B9;"> 
  ...
  <div component="$UI/system/components/bootstrap/row/row" class="row w100" xid="row38">
   <div class="col col-xs-6" xid="col107"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="确定" xid="button8" onClick="button8Click">
    <i xid="i8"></i>
    <span xid="span158">确定</span></a></div>
   <div class="col col-xs-6" xid="col108"><a component="$UI/system/components/justep/button/button" class="btn x-orange" label="取消" xid="button7" onClick="button7Click">
    <i xid="i7"></i>
    <span xid="span157">取消</span></a></div>
   </div></div></div>
      </div>
    </div>
  </div>
                  ...
                  <div class="x-panel-bottom bottom-btn-wrap" xid="bottom7">
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col col-xs-6" xid="col62">
                        <a component="$UI/system/components/justep/button/button" class="btn btn-success" label="确认" xid="buttonGit" onClick="buttonGitClick"> 
                          <i xid="i45" />  
                      ...
                      <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button44" bind-click="button44Click"> 
                          <i xid="i46" />  
                ...
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-bottom bottom-btn-wrap" xid="bottom7">
                    <div component="$UI/system/components/bootstrap/row/row"
                      class="row" xid="row16"> 
                      <div class="col col-xs-6" xid="col62">
                        <a component="$UI/system/components/justep/button/button" class="btn btn-success" label="确认" xid="button43" onClick="button43Click"> 
                          <i xid="i45" />  
                          <span xid="span99">确认</span>
                        </a>
                      </div>  
                      ...
                      <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button44" bind-click="closeGive"> 
                          <i xid="i46" />  
                          <span xid="span100">返回</span>
                        </a></div> 
                    </div>
  ...
  <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row18">
   ...
   <div class="x-panel-bottom order-info-button" xid="bottom10"><a component="$UI/system/components/justep/button/button" class="btn back-btn" label="返回" xid="button50" bind-click="button50Click">
   <i xid="i52"></i>
   <span xid="span90">返回</span></a></div></div></div>
      ...
      <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver box-style" xid="yet-sort" opacity="1">
   <div class="x-popOver-overlay" xid="div87"></div>
   <div class="x-popOver-content pop-container" xid="div88"><div xid="div96" class="pop-wrap" style="height:94%;">
      ...
      <div class="x-contents-content" xid="content25">
       <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel17">
        ...
        <div class="x-panel-bottom order-info-button" xid="bottom15">
         <a component="$UI/system/components/justep/button/button" class="btn back-btn" label="返回" xid="button59" bind-click="button50Click">
          <i xid="i60"></i>
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list14" data="cancelReasonData">
   <ul class="x-list-template" xid="listTemplateUl15">
    <li xid="li4" bind-click="canelliClick" bind-text="val('zReason')"></li></ul> </div>
  </div> 
        <div class="x-panel-bottom bottom-btn-wrap" xid="bottom11">
         <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row26">
          ...
          <div class="col col-xs-6" xid="col70">
            ...
            <i xid="i59"></i>
            <span xid="span101">返回</span></a></div> </div> </div> </div> </div> </div> </div> </div> </div></div></div><div component="$UI/system/components/justep/popOver/popOver" class="x-popOver box-style" xid="account" opacity="1">
   <div class="x-popOver-overlay" xid="div89"></div>
   <div class="x-popOver-content pop-container" xid="div90"><div xid="div132" class="pop-wrap" style="height:94%;">
        ...
        <div class="x-panel-bottom bottom-btn-wrap" xid="bottom17">
         <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row30">
          ...
          <div class="col col-xs-6" xid="col90">
            <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button61" bind-click="closeAccount">
            <i xid="i63"></i>
        ...
        <div class="x-panel-bottom bottom-btn-wrap" xid="bottom19">
         <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row28">
          ...
          <div class="col col-xs-6" xid="col96">
            <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button66" bind-click="closeAccount">
            <i xid="i66"></i>
        ...
        <div class="x-panel-bottom bottom-btn-wrap" xid="bottom18">
         <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row27">
          ...
          <div class="col col-xs-6" xid="col98">
            <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button62" bind-click="closeAccount">
            <i xid="i62"></i>
  ...
  <column name="checkOutMoney" xid="column53"></column></columns></div></div> 
        <div class="x-panel-bottom order-info-button" xid="bottom20">
         <a component="$UI/system/components/justep/button/button" class="btn back-btn" label="返回" xid="button69" bind-click="closeAccount">
          <i xid="i69"></i>
        ...
        <div class="x-panel-bottom bottom-btn-wrap" xid="bottom16">
         <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row33">
          ...
          <div class="col col-xs-6" xid="col87">
            ...
            <i xid="i68"></i>
            <span xid="span117">返回</span></a></div> </div> </div> </div> </div> 
  <div class="x-contents-content" xid="content53"><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel29">
   <div class="x-panel-top" xid="top25">
    <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="会员卡号">
     <div class="x-titlebar-left" xid="div54"></div>
     <div class="x-titlebar-title" xid="div55">会员卡号</div>
     <div class="x-titlebar-right reverse" xid="div50"></div></div> </div> 
     ...
     <div class="con-con" xid="div44">
      <div xid="div51">
       <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelInput6">
        ...
        <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input6" placeHolder="请输入会员卡号" id="noOrderChangeName"></input></div> 
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelInput8">
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input8" placeHolder="请输入密码" id="noOrderChangeName"></input></div></div> </div> </div> </div> 
   <div class="x-panel-bottom bottom-btn-wrap" xid="bottom24">
    <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row39">
     <div class="col col-xs-6" xid="col114">
      <a component="$UI/system/components/justep/button/button" class="btn btn-success" label="确认" xid="button2" onClick="button43Click">
       <i xid="i2"></i>
       <span xid="span4">确认</span></a> </div> 
     <div class="col col-xs-6" xid="col110">
      <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button3" bind-click="closeAccount">
       <i xid="i3"></i>
       <span xid="span3">返回</span></a> </div> </div> </div> </div></div></div> </div> </div> </div></div></div><resource xid="resource2"><require xid="require1" url="$UI/demo/baas/baas"></require></resource></div>