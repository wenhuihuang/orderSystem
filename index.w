...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="width:234px;height:auto;left:275px;top:424px;" onLoad="modelLoad"> <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="language" idColumn="col0" confirmDelete="false" autoNew="true"><column name="col0" type="String" xid="xid65"></column>  <column label="在用" name="USING" type="String" xid="xid66"></column>
 ...
 <li xid="li2" bind-click="li2Click"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output5" bind-ref="ref('typeName')"></div>
  ...
  <div xid="div15" class="pop-con-title">
   ...
   <div class="x-panel-bottom" xid="bottom23" height="35"><div xid="div68" class="pop-menu-btn"> 
              ...
              <div class="x-contents-content" xid="content14"><div xid="div23" class="have-wrap"><div xid="div72"><h3 xid="h32" bind-text=" $model.currentDeskData.val(&quot;tai_number&quot;) +'（'+ $model.currentDeskData.val(&quot;custQty&quot;)+'）'"><![CDATA[十号台（1人）]]></h3><table class="table table-bordered table-hover table-striped" component="$UI/system/components/bootstrap/table/table" xid="table1">
   <thead xid="thead1">
    <tr xid="tr1">
  ...
  <column name="checkOutMoney" xid="column53"></column></columns></div></div> 
        <div class="x-panel-bottom order-info-button" xid="bottom20">
         <a component="$UI/system/components/justep/button/button" class="btn x-orange" label="返回" xid="button69" bind-click="closeAccount">
          <i xid="i69"></i>
