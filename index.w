...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelRange1">
   ...
   <input component="$UI/system/components/justep/input/range" class="x-edit" xid="range1"></input></div><div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:877px;top:274px;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column label="台号" name="tai_number" type="String" xid="default11"/>  
      <column label="状态" name="state" type="String" xid="default12"/>  
      <column label="房号id" name="roomId" type="String" xid="default13"/>  
      <column label="订单号" name="billMasterId" type="String" xid="default2"/>  
      <column label="台" name="roomCode" type="String" xid="xid17"/>
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
            ...
            <p xid="p79" class="login-wrap"> 
              <div component="$UI/system/components/bootstrap/row/row" class="row"
                ...
                <div class="col col-xs-6" xid="col3">
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-default btn-login" label="登录" xid="login_btn" bind-click="login_btnClick"> 
                    <i xid="i16"/>  
        ...
        <div class="x-panel-top" xid="top2"> 
          <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
            ...
            <div class="x-titlebar-left" xid="div49">
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon color-green"
                xid="button19" icon="icon-android-arrow-back" bind-click="button19Click"> 
                <i xid="i21" class="icon-android-arrow-back"/>  
                <span xid="span41"/>
              </a>
            </div>  
                ...
                <div component="$UI/system/components/justep/list/list" class="x-list"
                  ...
                  <ul class="x-list-template" xid="listTemplateUl5"> 
                    <li xid="li14"> 
                      ...
                      <div xid="div74" bind-click="div74Click" style="height:35px;"
                        bind-text="val('cookWay')">点击</div> 
                    </li> 
                  </ul> 
                </div>  
          ...
          <div class="x-panel-bottom" xid="bottom3"> 
            <div xid="div45" class="bottom-wrap"> 
              ...
              <div xid="div47" class="poop-bottom-right"> 
                <a component="$UI/system/components/justep/button/button"
                  class="btn btn-default send-order-btn" label="送单" xid="button5"
      ...
      <div xid="div78" style="height:94%;" class="edit-add"> 
        <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
            ...
            <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
              ...
              <div class="x-panel-top" xid="top5" height="160">
                ...
                <div xid="div81"> 
                  ...
                  <div component="$UI/system/components/justep/list/list" class="x-list ed-con-con "
                    xid="list9" data="currentCookWayData"> 
              ...
              <div class="x-panel-content" xid="content6">
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-top" xid="top6">
                    <div xid="div82" class="edit-container-title"> 
                      <a component="$UI/system/components/justep/button/button"
                        class="btn btn-default" label="数量" xid="button12" bind-click="button12Click"
                        target="content5"> 
                        <i xid="i12"/>  
                        <span xid="span162">数量</span> 
                      </a>  
                      <a component="$UI/system/components/justep/button/button"
                        class="btn btn-default" label="口味" xid="button13" bind-click="button13Click"
                        target="content8"> 
                        <i xid="i13"/>  
                        <span xid="span163">口味</span> 
                      </a>  
                      <a component="$UI/system/components/justep/button/button"
                        class="btn btn-default require" label="要求 " xid="button14"
                        target="content9" onClick="button14Click"> 
                        <i xid="i14"/>  
                        <span xid="span164">要求</span> 
                      </a>  
                      <a component="$UI/system/components/justep/button/button"
                        class="btn btn-default" label="其他" xid="button15" bind-click="button15Click"
                        target="content10"> 
                        <i xid="i15"/>  
                  ...
                  <div class="x-panel-content" xid="content7">
                    <div component="$UI/system/components/justep/contents/contents"
                      class="x-contents x-full" active="0" xid="contents2" swipe="false"> 
                      <div class="x-contents-content" xid="content5"> 
                        <div class="select-con-wrap" style="text-align:center;">
                          <h5>
                            <a href="javascript:;" class="subtract" id="popOver2Sub"
                              bind-click="a2Click"/>
                            <span bind-text="currentGoodsData.ref('qty')">1</span>
                            <a href="javascript:;" class="add" id="popOver2Add"
                              bind-click="a1Click"/>
                          </h5> 
                        </div> 
                      </div>  
                      ...
                      <div class="x-contents-content" xid="content9"> 
                        <div xid="div9" class="require-title-wrap"> 
                          <div component="$UI/system/components/justep/list/list"
                            class="x-list require-title clearfix" xid="list7" data="cookTypeData"> 
                        ...
                        <div class="select-con-wrap"> 
                          <div component="$UI/system/components/justep/list/list"
                            ...
                            <ul class="x-list-template clearfix" xid="listTemplateUl8"> 
                              <li xid="li5" bind-text="val('cookWay')" bind-click="li5Click"/>
                            </ul> 
                          </div>
                        </div> 
                      </div>  
                      <div class="x-contents-content" xid="content10"> 
                        <textarea class="select-con-wrap" placeholder="请输入要求"/> 
                      </div>
                    </div>
                  </div> 
                </div>
          ...
          <div class="x-panel-bottom edit-add-bottom" xid="bottom4"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-default"
              label="取消" xid="button7" onClick="button7Click"> 
              <i xid="i7"/>  
              <span xid="span157">取消</span>
            </a>  
            <a component="$UI/system/components/justep/button/button" class="btn btn-default"
              label="确定" xid="button8" onClick="button8Click"> 
              <i xid="i8"/>  
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver renShu"
    xid="popOver_renshu" opacity="0.9"> 
    ...
    <div class="x-popOver-content con-wrap" xid="div6">
      <div xid="div7" class="con-con">
        ...
        <input component="$UI/system/components/justep/input/input" class="form-control"
          xid="input1" placeHolder="输入人数" id="custNum" dataType="Integer"/>
      ...
      <div xid="div13" class="con-con"> 
        <div xid="div16" class="pop-title">
          ...
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
              xid="input3" placeHolder="台号" disabled="true"/>
          </div>
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
        ...
        <div xid="div12" class="btn-wrap"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-default do-btn"
            label="确认" xid="button25"> 
            <i xid="i28"/>  
            <span xid="span15">确认</span>
          </a>
          <a component="$UI/system/components/justep/button/button" class="btn btn-default undo-btn"
