...
<div component="$UI/system/components/justep/popOver/popOver" class="x-popOver renShu" xid="popOver_renshu" opacity="0.9">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default do-btn" label="确认" xid="button25" onClick="button16Click">
      ...
      <span xid="span14">取消</span></a></div> </div></div></div>
        ...
        <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" xid="order" style="box-shadow:0 0px 2px 2px #c9B9B9;" opacity="0.9">
   <div class="x-popOver-overlay" xid="div10"></div>
    ...
    <div xid="div12" class="pop-wrap" style="height:94%;">
     <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel7">
      <div class="x-panel-top" xid="top7" height="48">
       <div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup2"><a component="$UI/system/components/justep/button/button" class="btn btn-default" label="没分单" xid="button27" target="content12">
   <i xid="i29"></i>
   <span xid="span29">没分单</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="已分单" xid="button28" target="content13">
   <i xid="i30"></i>
   <span xid="span30">已分单</span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="结账单" xid="button29" target="content14">
   <i xid="i31"></i>
  ...
  <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full" active="0" xid="contents3">
   <div class="x-contents-content" xid="content12"><div xid="div16" class="pop-con">
        <div class="con-con" xid="div18">
         ...
         <div xid="div14" class="pop-con-title"><div component="$UI/system/components/bootstrap/row/row" class="row" xid="row4">
   <div class="col col-xs-5dot2 " xid="col10"><span xid="span53"><![CDATA[菜名]]></span>
  </div>
   <div class="col col-xs-1dot7" xid="col11"><span xid="span54"><![CDATA[单价]]></span></div>
   <div class="col col-xs-1dot7" xid="col12"><span xid="span55"><![CDATA[数量]]></span></div>
  <div class="col col-xs-1dot7" xid="col13"><span xid="span56"><![CDATA[加收]]></span></div>
  <div class="col col-xs-1dot7" xid="col18">
   <span xid="span61">总价</span></div></div></div><div component="$UI/system/components/justep/list/list" class="x-list" xid="list10" data="cartData">
   ...
   <div class="col col-xs-1dot7" xid="col23">
    <span xid="span66" bind-text="val('sprice') * val('qty')+val('addMoney')">总价</span></div> </div></li> </ul> </div> 
         
         </div> 
  <div xid="div32" class="pop-menu-btn"><div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup3"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" xid="button30" icon="icon-android-add">
   <i xid="i32" class="icon-android-add"></i>
   <span xid="span67"></span></a>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" xid="button31" icon="icon-android-remove">
  ...
  <div class="x-contents-content" xid="content13"><div xid="div28" class="pop-con">
   ...
   <p class="no-send" xid="p1">
    ...
    <span xid="span25" bind-text=" '合计(元)：'+$model.statusData.val(&quot;orderTotal&quot;)">合计(元):20.00</span></p> 
     ...
     <li xid="li4">
      <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row7">
       ...
       <div class="col col-xs-1dot7" xid="col28">
        <span xid="span43" bind-text="val('sprice') * val('qty')+val('addMoney')">总价</span></div> </div> </li> </ul> </div> </div>
  </div></div>
  <div class="x-contents-content" xid="content14"></div></div></div> 
      <div class="x-panel-bottom" xid="bottom5">
       <div xid="div20" class="bottom-wrap">
        <div xid="div21" class="pop-bottom-left">总价格(元):
         <div component="$UI/system/components/justep/output/output" class="x-output dib color-price" xid="output6" bind-text=' $model.statusData.val("orderTotal") + $model.statusData.val("cartTotal")' style="background-color:transparent;"></div></div> 
