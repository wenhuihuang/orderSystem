...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="width:234px;height:auto;left:660px;top:79px;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column label="在用" name="USING" type="String" xid="xid66"/>  
      <column label="用户名" name="USERNAME" type="String" xid="xid67"/>  
      <column label="密码" name="PASSWORD" type="String" xid="xid68"/>  
      <column label="欢迎使用点餐系统" name="WELCOME" type="String" xid="xid69"/>  
      <column label="请输入用户名和密码登录" name="CHECKLOGIN" type="String" xid="xid70"/>  
      <column label="退出" name="EXIT" type="String" xid="xid71"/>  
      <column label="登录" name="LOGIN" type="String" xid="xid72"/>  
      <column label="菜单" name="MENU" type="String" xid="xid73"/>  
      <column label="空台" name="EMPTY" type="String" xid="xid74"/>  
      <column label="埋单" name="PAY" type="String" xid="xid75"/>  
      <column label="预定" name="RESERVE" type="String" xid="xid76"/>  
      <column label="禁用" name="OFF" type="String" xid="xid77"/>  
      <column label="已点详情" name="DETAILS" type="String" xid="xid78"/>  
      <column label="没分单" name="NOSORT" type="String" xid="xid79"/>  
      <column label="已分单" name="COMPLETESORT" type="String" xid="xid80"/>  
      <column label="结算单" name="SETTLEMENT" type="String" xid="xid81"/>  
      <column label="菜名" name="DISHNAME" type="String" xid="xid82"/>  
      <column label="单价" name="PRICE" type="String" xid="xid83"/>  
      <column label="数量" name="QUANTITY" type="String" xid="xid84"/>  
      <column label="加收" name="ADDED" type="String" xid="xid85"/>  
      <column label="总价" name="TOTALPRICES" type="String" xid="xid86"/>  
      <column label="赠送" name="GIVE" type="String" xid="xid87"/>  
      <column label="多食" name="POLYPHAGIA" type="String" xid="xid88"/>  
      <column label="返回" name="BACK" type="String" xid="xid89"/>  
      <column label="送单" name="SENDSHEET" type="String" xid="xid90"/>  
      <column label="关闭" name="CLOSE" type="String" xid="xid91"/>  
      <column label="修改菜名" name="EDITSISH" type="String" xid="xid92"/>  
      <column label="确认" name="CONFIRM" type="String" xid="xid93"/>  
      <column label="修改价格" name="EDITPRICE" type="String" xid="xid94"/>  
      <column label="修改数量" name="EDITQUANTITY" type="String" xid="xid95"/>  
      <column label="催菜" name="URGE" type="String" xid="xid96"/>  
      <column label="收起" name="CALLUP" type="String" xid="xid97"/>  
      <column label="打折" name="DISCOUNT" type="String" xid="xid98"/>  
      <column label="全单催菜" name="ALLURGE" type="String" xid="xid99"/>  
      <column label="全单叫起" name="ALLCALLUP" type="String" xid="xid100"/>  
      <column label="修改单号" name="EDITOODNUM" type="String" xid="xid101"/>  
      <column label="修改原始单号" name="EDITSERVER" type="String" xid="xid102"/>  
      <column label="会员打折" name="MEMBERDISCOUNT" type="String" xid="xid103"/>  
      <column label="重打总单" name="ALLSHEET" type="String" xid="xid104"/>  
      <column label="修改人数" name="EDITPEOPLENUMBER" type="String" xid="xid105"/>  
      <column label="最低消费" name="EDITMINIMUM" type="String" xid="xid106"/>  
      <column label="管理员" name="ADMIN" type="String" xid="xid107"/>  
      <column label="原始单号" name="ODDNUM" type="String" xid="xid108"/>  
      <column label="会员卡号" name="MEMBERNUM" type="String" xid="xid109"/>  
      <column label="取消埋单" name="CANCELPAL" type="String" xid="xid110"/>  
      <column label="消费合计" name="TOTAL" type="String" xid="xid111"/>  
      <column label="服务费" name="SERVICECHARGE" type="String" xid="xid112"/>  
      <column label="折扣额" name="DEDUCTION" type="String" xid="xid113"/>  
      <column label="应付合计" name="ACCRUEDEXP" type="String" xid="xid114"/>  
      <column label="请输入就餐人数" name="INPUTNUM" type="String" xid="xid115"/>  
      <column label="取消" name="CANCEL" type="String" xid="xid116"/>  
      <column label="搭台" name="STAGE" type="String" xid="xid117"/>  
      <column label="台号" name="AHO" type="String" xid="xid118"/>  
      <column label="人数" name="NNT" type="String" xid="xid119"/>  
      <column label="总价格(元)" name="TOTALPRICESYUN" type="String" xid="xid120"/>  
      <column label="总数量" name="TOTALQ" type="String" xid="xid121"/>  
      <column label="价格" name="PRICES" type="String" xid="xid122"/>  
      <column label="并台" name="COMBINE" type="String" xid="xid125"/>  
      <column label="转台" name="TURNTABLE" type="String" xid="xid126"/>  
      <column label="零结账" name="ZERO" type="String" xid="xid127"/>  
      <column label="点菜" name="ORDER" type="String" xid="xid128"/>  
      <column label="用户名或密码有误" name="USERORPWD" type="String" xid="xid129"/>
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
              ...
              <div xid="div37">
                <div component="$UI/system/components/bootstrap/row/row" class="row w100"
                  ...
                  <div class="col col-xs-9" xid="col105">
                    <input component="$UI/system/components/justep/input/input"
                      class="form-control" xid="searchGoodsInput" placeHolder="请输入拼音或编码"/>
                  </div>  
    ...
    <div class="x-popOver-content con-wrap" xid="div6">
      <div xid="div7" class="con-con">
        ...
        <div xid="div8" class="btn-wrap">
          ...
          <a component="$UI/system/components/justep/button/button" class="btn btn-default do-btn"
            label="确认" xid="button16" onClick="button16Click"> 
            <i xid="i18"/>  
    ...
    <div class="x-popOver-content con-wrap" xid="div11">
      <div xid="div13" class="con-con"> 
        ...
        <div xid="div12" class="btn-wrap"> 
          <a component="$UI/system/components/justep/button/button" class="btn btn-default undo-btn"
            label="取消" xid="button26" bind-click="button26Click"> 
            <i xid="i27"/>  
            <span xid="span14" bind-text="language.ref('CANCEL')">取消</span>
          </a>
          <a component="$UI/system/components/justep/button/button" class="btn btn-default do-btn"
            label="确认" xid="button25" onClick="button25Click"> 
            <i xid="i28"/>  
            <span xid="span15" bind-text="language.ref('CONFIRM')">确认</span>
          </a>
        </div> 
      </div>
    </div>
        ...
        <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
          ...
          <div class="x-panel-content" xid="content11"> 
            <div component="$UI/system/components/justep/contents/contents"
                ...
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-content" xid="content52">
                    <div xid="div16" class="pop-con"> 
                      <div class="con-con" xid="div18"></div>  
                      <div xid="pop-menuSub-btn" class="pop-menuSub-btn no-single"> 
                        ...
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-4" xid="col25"> 
                            <span xid="span20" bind-click="button13Click"><![CDATA[口味]]></span>
                          </div>
                        </div>  
                        <div component="$UI/system/components/bootstrap/row/row"
                          class="row" xid="row5"> 
                          <div class="col col-xs-4" xid="col24"> 
                            <span xid="span21" bind-click="button14Click"><![CDATA[要求]]></span>
                          </div>  
                          <div class="col col-xs-4" xid="col58"> 
                            <span xid="span28" bind-click="button15Click">其它</span>
                          </div>  
                          <div class="col col-xs-4" xid="col17"> 
                            <span xid="span131" bind-click="button6Click" bind-text="language.ref('BACK')"
                              class="back">返回</span>
                          </div>
                        </div>
                      </div> 
                      ...
                      <div class="x-panel-bottom" xid="bottom8" height="35">
                        <div xid="div32" class="pop-menu-btn"> 
                          <div component="$UI/system/components/justep/button/buttonGroup"
                            ...
                            <a component="$UI/system/components/justep/button/button"
                              class="btn btn-link" xid="button33" bind-click="button33Click"
                              label="更多"> 
                              <i xid="i35"/>  
              ...
              <div class="x-contents-content" xid="content13"> 
                <div xid="div28" class="pop-con"> 
                  <div class="con-con" xid="div17"></div>  
                  <div class="pop-menuSub-btn has-single"> 
                    ...
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col col-xs-4" xid="col14"> 
                        <span xid="span16" bind-click="hiedClick" class="back">返回</span>
                      </div>
                    </div>
                  </div> 
                </div>  
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full con-con"
                  xid="panel30"> 
                        ...
                        <li xid="horderli" bind-click="horderliClick"> 
                          <div component="$UI/system/components/bootstrap/row/row"
                            ...
                            <div class="col col-xs-1dot7" xid="col28"> 
                              <span xid="span43" bind-text="val('totalPrice')"
                                class="color-price">总价</span>
                            </div> 
                          </div> 
                        </li> 
                    ...
                    <div xid="div68" class="pop-menu-btn"> 
                      <div component="$UI/system/components/justep/button/buttonGroup"
                        ...
                        <a component="$UI/system/components/justep/button/button"
                          ...
                          <i xid="i43" class="icon-android-add color-style"/>  
                          <span xid="span51"/> 
                        </a>  
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-link btn-only-icon" xid="button45" icon="icon-android-remove"> 
                          <i xid="i42" class="icon-android-remove color-style"/>  
                          <span xid="span50"/> 
                        </a>  
                        <a component="$UI/system/components/justep/button/button"
            ...
            <div xid="div72" class="have-con">
                    ...
                    <div component="$UI/system/components/bootstrap/row/row"
                      class="row top-border" xid="row41"> 
                  ...
                  <div xid="div73">
                    <div xid="div75" class="pop-menu-btn"> 
                      <div component="$UI/system/components/justep/button/buttonGroup"
                        class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup5"> 
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-link" xid="button46" label="预览结帐单" bind-click="span92Click"> 
                          <i xid="i50"/>  
                          <span xid="span57" class="color-style">预览结帐单</span>
                        </a>  
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-link" xid="button49" label="输入会员卡号" bind-click="button49Click"> 
                          <i xid="i48"/>  
                          <span xid="span52" class="color-style">输入会员卡号</span>
                        </a>  
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-link" xid="button47" label="更多" bind-click="button47Click"> 
                          <i xid="i49"/>  
                          <span xid="span58" class="color-style">更多</span>
                        </a> 
                      </div> 
                    </div>
                    <div xid="div83" class="pop-menuSub-btn  statement-btn"> 
                      <div component="$UI/system/components/bootstrap/row/row"
                        class="row" xid="row13"> 
                        <div class="col col-xs-4" xid="col48"> 
                          <span xid="span73"><![CDATA[修改原始单号]]></span>
                        </div>  
                        <div class="col col-xs-4" xid="col49"> 
                          <span xid="span74"><![CDATA[修改服务费率]]></span>
                        </div>  
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver box-style"
    ...
    <div class="x-popOver-content pop-container" xid="div27" style="width:95%;height:96%;"> 
      <div xid="div38" class="pop-wrap" style="height:94%;"> 
        <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
          xid="panel8"> 
          <div class="x-panel-content" xid="content18"> 
            <div component="$UI/system/components/justep/contents/contents"
              class="x-contents x-full" active="0" xid="contents4" swipe="false" wrap="false"
              slidable="false"> 
                          ...
                          <div class="select-con-wrap" xid="div61"> 
                            <div component="$UI/system/components/justep/list/list"
                              ...
                              <ul class="x-list-template clearfix" xid="listTemplateUl14"> 
                                <li xid="gitli" bind-text="val('zReason')"
                                  bind-click="gitliClick"/> 
                              </ul> 
                            </div> 
                          </div> 
                        </div> 
              ...
              <div class="x-contents-content" xid="order-info"> 
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-top" xid="top8">
                    <h3 xid="h33" class="order-info-title"><![CDATA[大酒店]]></h3>
                  </div>  
                  <div class="x-panel-content" xid="content26">
                    <div xid="div84" class="order-info-wrap">
                      <div xid="div85">
                        <div component="$UI/system/components/bootstrap/row/row"
                          class="row" xid="row15"> 
                          <div class="col col-xs-4" xid="col54">
                            <span xid="span78"><![CDATA[管理员：]]></span>
                          </div>  
                          <div class="col col-xs-8" xid="col55">
                            <span xid="span79"><![CDATA[]]></span>
                          </div> 
                        </div>  
                        <div component="$UI/system/components/bootstrap/row/row"
                          class="row" xid="row17"> 
                          <div class="col col-xs-4" xid="col59">
                            <span xid="span80"><![CDATA[台号：]]></span>
                          </div>  
                          <div class="col col-xs-8" xid="col57">
                            <span xid="span81"/>
                          </div> 
                        </div>  
                        <div component="$UI/system/components/bootstrap/row/row"
                          class="row" xid="row18"> 
                          <div class="col col-xs-4" xid="col64">
                            <span xid="span82"><![CDATA[单号：]]></span>
                          </div>  
                          <div class="col col-xs-8" xid="col60">
                            <span xid="span87"/>
                          </div> 
                        </div>
                      </div>
                      ...
                      <div xid="div86">
                        <h3 xid="h34"><![CDATA[总金额：]]></h3>
                        <p xid="p2">
                          <span xid="span89"><![CDATA[欢迎下次光临]]></span>
                        </p>
                      </div> 
                    </div>
                  </div>  
                  <div class="x-panel-bottom order-info-button" xid="bottom10">
                    <a component="$UI/system/components/justep/button/button"
                      class="btn back-btn" label="返回" xid="button50" bind-click="button50Click"> 
                      <i xid="i52"/>  
                      <span xid="span90">返回</span>
                    </a>
                  </div>
                </div>
              </div> 
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver box-style"
    ...
    <div class="x-popOver-content pop-container" xid="div88">
              ...
              <div class="x-contents-content" xid="content27"> 
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-top" xid="top13"> 
                    <div component="$UI/system/components/justep/titleBar/titleBar"
                      class="x-titlebar" xid="titleBar6" title="赠送"> 
                      <div class="x-titlebar-left" xid="div126"/>  
                      <div class="x-titlebar-title" xid="div93" title="赠送"/>  
                      ...
                      <div class="con-con" xid="div112"> 
                        ...
                        <div xid="div122"> 
                          <div class="select-con-wrap" xid="div120"> 
                            <div component="$UI/system/components/justep/list/list"
                              class="x-list require-con" xid="list12" data="presentsReasonData"> 
                              <ul class="x-list-template clearfix" xid="listTemplateUl12"> 
                                <li xid="li7" bind-text="val('zReason')" bind-click="gitliClick"/>
                              </ul> 
                            </div> 
                          </div> 
                        </div> 
                  ...
                  <div class="x-panel-bottom bottom-btn-wrap" xid="bottom12"> 
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col col-xs-6" xid="col74"> 
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-success" label="确认" xid="hbutton58" onClick="hbutton58Click"> 
                          <i xid="i55"/>  
              ...
              <div class="x-contents-content" xid="content25"> 
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-top" xid="top16"> 
                    <h3 xid="h35" class="order-info-title">大酒店</h3>
                  </div>  
                  ...
                  <div class="x-panel-bottom order-info-button" xid="bottom15"> 
                    <a component="$UI/system/components/justep/button/button"
                      class="btn back-btn" label="返回" xid="button59" bind-click="button50Click"> 
                      <i xid="i60"/>  
                      <span xid="span97">返回</span>
                    </a> 
                  </div> 
                </div> 
              </div>  
              <div class="x-contents-content" xid="content33"> 
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-top" xid="top15"> 
                    <div component="$UI/system/components/justep/titleBar/titleBar"
                      class="x-titlebar" xid="titleBar8" title="退菜"> 
                      <div class="x-titlebar-left" xid="div111"/>  
                  ...
                  <div class="x-panel-bottom bottom-btn-wrap" xid="bottom11"> 
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col col-xs-6" xid="col70"> 
                        <a component="$UI/system/components/justep/button/button"
                          class="btn x-orange" label="返回" xid="button54" bind-click="hbutton44Click"> 
                          <i xid="i59"/>  
                          <span xid="span101">返回</span>
                        </a>
                      </div> 
                    </div> 
                  </div> 
              ...
              <div class="x-contents-content" xid="content39"> 
                <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
                  ...
                  <div class="x-panel-top" xid="top18"> 
                    <div component="$UI/system/components/justep/titleBar/titleBar"
                      class="x-titlebar" xid="titleBar10" title="打折"> 
                      <div class="x-titlebar-left" xid="div156"/>  
                      <div class="x-titlebar-title" xid="div129" title="赠送"
                        bind-text=" $model.language.val(&quot;DISCOUNT&quot;)">打折</div>  
                      ...
                      <div class="con-con" xid="div142"> 
                        ...
                        <div xid="div152"> 
                          <div class="select-con-wrap" xid="div150"> 
                            <div component="$UI/system/components/justep/list/list"
                              class="x-list require-con" xid="list13" data="discountTypesData"> 
                              <ul class="x-list-template clearfix" xid="listTemplateUl13"> 
                                <li xid="li9" bind-text="val('discountTypeName')"
                                  bind-click="li9Click"/>
                              </ul> 
                            </div> 
                          </div> 
                  ...
                  <div class="x-panel-bottom bottom-btn-wrap" xid="bottom17"> 
                    <div component="$UI/system/components/bootstrap/row/row"
                      ...
                      <div class="col col-xs-6" xid="col91"> 
                        <a component="$UI/system/components/justep/button/button"
                          class="btn btn-success" label="确认" xid="button68" onClick="button68Click"> 
                          <i xid="i64"/>  
                      ...
                      <div xid="div153"> 
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-4" xid="col97"> 
                            <span xid="span128">管理员：</span>
                          </div>  
                          <div class="col col-xs-8" xid="col86"> 
                            <span xid="span127" bind-text="userData.ref('userName')"/>
                          </div> 
                        </div>  
                        <div component="$UI/system/components/bootstrap/row/row"
                          class="row" xid="row31"> 
                          <div class="col col-xs-4" xid="col85"> 
                            <span xid="span120">台号：</span>
                          </div>  
                        ...
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-4" xid="col93"> 
                            <span xid="span121">单号：</span>
                          </div>  
                          <div class="col col-xs-8" xid="col94"> 
                            <span xid="span126" bind-text="ConsumeBillData.ref('billNO')"/>
                          </div> 
                        </div> 
                      </div>  
                      <div xid="div154"> 
  ...
  <span xid="span151" class="color-price" bind-text="statusData.ref('totalCheckOutMoney')"></span></h3>  
   ...
   <div class="col col-xs-3" xid="col139"><h5 xid="h511"><![CDATA[数量]]></h5></div>
   <div class="col col-xs-3" xid="col140"><h5 xid="h512"><![CDATA[金额]]></h5></div></div>
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list5" data="showBillData">
   <ul class="x-list-template" xid="listTemplateUl5">
    <li xid="li12"><div component="$UI/system/components/bootstrap/row/row" class="row" xid="row50">
   <div class="col col-xs-6" xid="col143">
    <span xid="span146" bind-text="val('goodsName')"></span></div> 
